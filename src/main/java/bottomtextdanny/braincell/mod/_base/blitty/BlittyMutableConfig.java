...
public class BlittyMutableConfig implements BlittyConfig {
   ...
   public BlittyMutableConfig(@Nullable BlittyColorTransformer colorTransformer, @Nullable BlittyPosTransformer posTransformer, @Nullable BlittyUVPosTransformer uvTransformer) {
