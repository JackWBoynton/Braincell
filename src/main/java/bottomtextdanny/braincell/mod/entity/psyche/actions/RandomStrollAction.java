...
public class RandomStrollAction extends Action {
   ...
   public boolean shouldKeepGoing() {
      return !this.mob.getNavigation().isDone() && !this.mob.getNavigation().isStuck() && !this.mob.isVehicle() && this.active();
   }
   ...
   protected Vec3 getRandomPosition() {
      BlockPos pos = this.posProcessor.compute(this.mob.blockPosition(), this.mob, UNSAFE_RANDOM, (Object)null);
