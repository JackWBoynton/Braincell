...
public final class BCArith {
   ...
   public static double dot(Vec3i vec0, Vec3i vec1) {
      return (double)vec0.getX() * (double)vec1.getX() + (double)vec0.getY() * (double)vec1.getY() + (double)vec0.getZ() * (double)vec1.getZ();
   }

   public static float fDot(Vec3i vec0, Vec3i vec1) {
      return (float)vec0.getX() * (float)vec1.getX() + (float)vec0.getY() * (float)vec1.getY() + (float)vec0.getZ() * (float)vec1.getZ();
   }
}
