...
public final class BCDistance2Getter {
   ...
   public Start2D start(Vec2 vector) {
      this.start.set((double)vector.x, (double)vector.y);
      return this.start;
   }

   public Start2D start(double[] vector) {
      this.start.set(vector[0], vector[1]);
      return this.start;
   }

   public Start2D start(float[] vector) {
      this.start.set((double)vector[0], (double)vector[1]);
      return this.start;
   }
   ...
   public static final class Start2D {
      ...
      public double get(Vec2 vector) {
         return this.get((double)vector.x, (double)vector.y);
      }

      public double getManhattan(Vec2 vector) {
         return this.getManhattan((double)vector.x, (double)vector.y);
      }

      public double get(double[] vector) {
         return this.get(vector[0], vector[1]);
      }

      public double getManhattan(double[] vector) {
         return this.getManhattan(vector[0], vector[1]);
      }

      public double get(float[] vector) {
         return this.get((double)vector[0], (double)vector[1]);
      }

      public double getManhattan(float[] vector) {
         return this.getManhattan((double)vector[0], (double)vector[1]);
      }
   }
}
