...
public class HandAccessories {
    public static final ImmutableList<Function<BCAccessoryModule, StackAccessory>> ACCESSORY_FOR_HAND = ImmutableList.of(
            module -> module.getHandManager().main,
            module -> module.getHandManager().off
    );
    public static final ImmutableList<Function<BCAccessoryModule, StackAccessory>> ACCESSORYO_FOR_HAND = ImmutableList.of(
            module -> module.getHandManager().mainO,
            module -> module.getHandManager().offO
    );
    public static final ImmutableList<BiConsumer<BCAccessoryModule, StackAccessory>> SET_BY_HAND = ImmutableList.of(
