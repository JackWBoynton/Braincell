...
@OnlyIn(Dist.CLIENT)
public class LoopedOpaqueParticle extends LoopedSpriteParticle {

    protected LoopedOpaqueParticle(ClientLevel world, double x, double y, double z,
        ...
        setSpriteGroup(SimpleSpriteGroup.of(handleSpriteSet, 7));
        setLocalSprite(0);
        setLinearFrameSpace();
    ...
    public static class Factory implements ParticleProvider<ModularParticleData> {
        ...
        public Particle createParticle(ModularParticleData typeIn, ClientLevel level, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            ...
            return new LoopedOpaqueParticle(level, x, y, z, xSpeed, ySpeed, zSpeed, loopTime, start == null ? ParticleAction.NO : start, ticker == null ? ParticleAction.NO : ticker, spriteSet);
        }
    }
}
