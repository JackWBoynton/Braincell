...
import bottomtextdanny.braincell.libraries.shader.ShaderBuffer;
import bottomtextdanny.braincell.libraries.shader.ShaderWorkflow;
import bottomtextdanny.braincell.libraries.shader.TextureBuffer;
...
public class PointLightingWorkflow extends ShaderWorkflow {
    ...
    public PointLightingWorkflow() {
        if (!Minecraft.ON_OSX) {
            ...
            this.lightRenderingProgram = null;
            this.frustumCalcProgram = null;
        }
    ...
    protected void execute() {
        ...
        if (frustumCalcProgram != null && lightRenderingProgram != null) {
