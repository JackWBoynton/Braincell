package bottomtextdanny.braincell.libraries._minor.boat.client;
...
public class BCBoatRenderer extends EntityRenderer<BCBoat> {
	...
	public BCBoatRenderer(EntityRendererProvider.Context renderManagerIn) {
        ...
        this.modelBoat = new BoatModel(renderManagerIn.bakeLayer(ModelLayers.createBoatModelName(Boat.Type.OAK)), false);
	}
