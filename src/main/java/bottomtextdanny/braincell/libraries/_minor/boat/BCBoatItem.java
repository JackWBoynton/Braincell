...
import bottomtextdanny.braincell.tables.BCEntities;
import bottomtextdanny.braincell.libraries._minor.boat.BCBoat;
import bottomtextdanny.braincell.libraries._minor.boat.BCBoatType;
...
public class BCBoatItem extends Item {
	...
	public BCBoatItem(BCBoatType typeIn, Properties properties) {
		super(properties);
		this.type = typeIn;
	}
	...
	public InteractionResultHolder<ItemStack> use(Level worldIn, Player playerIn, InteractionHand handIn) {
		...
		if (raytraceresult.getType() == HitResult.Type.MISS) {
			...
			if (raytraceresult.getType() == HitResult.Type.BLOCK) {
				BCBoat boatentity = new BCBoat(BCEntities.BOAT.get(), worldIn);
