...
public class SpellRenderer <E extends Entity, M extends BCEntityModel<E>> extends EntityRenderer<E> implements RenderLayerParent<E, M> {
    private static final ResourceLocation TEXTURES = null;
    private final M entityModel;
    protected final List<RenderLayer<E, M>> layerRenderers = new ArrayList<>();
