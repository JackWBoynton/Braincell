...
import net.bottomtextdanny.braincell.base.vector.BCDistance2Getter;
import net.bottomtextdanny.braincell.base.vector.BCDistance3Getter;
...
public final class BraincellHelper {
    ...
    public static final IllegalArgumentException INVALID_TOKEN_EX =
            new IllegalArgumentException("Tried to modify data with invalid token");
